                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <td width="50"><img class="img img-rounded" src="admin/<?php echo $student_row['location']; ?>" width="50" height="50"></td>
                            <td width="100">
                            ...
                            <div id="view<?php echo $student_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="span6">
                                 <img class="img img-rounded" src="admin/<?php echo $student_row['location']; ?>" width="250">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
