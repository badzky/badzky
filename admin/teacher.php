                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td width="150">
                                        ...
                                        <a rel="tooltip"  title="add class" id="f<?php echo $teacher_id; ?>" href="teacher_add_class_student.php<?php echo '?id='.$teacher_id; ?>" class="btn btn-primary"><i class="icon-book icon-large"></i></a>
